...
public class ObjectFactory {
    ...
    private static final QName _CatalogueStockageStockageCollectionEffect_QNAME = new QName("", "effect");
    private static final QName _CatalogueStockageStockageCollectionTerm_QNAME = new QName("", "term");
     ...
     * 
     * @return
     *     the new instance of {@link Catalogue.StockageStockage }
     */
    ...
    public JAXBElement<String> createCatalogueStockageStockageEffect(String value) {
        return new JAXBElement<>(new QName("", "effect"), String.class, Catalogue.StockageStockage.class, value);
    }
    ...
    public JAXBElement<String> createCatalogueStockageStockageTerm(String value) {
        return new JAXBElement<>(new QName("", "term"), String.class, Catalogue.StockageStockage.class, value);
    }
