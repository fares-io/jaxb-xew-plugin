...
public class ObjectFactory {
    ...
    private static final QName _Age_QNAME = new QName("http://example.com/extra", "age");
    private static final QName _IdListId_QNAME = new QName("http://example.com/scope", "id");
    private static final QName _ReturnUsersName_QNAME = new QName("http://example.com/scope", "name");
    private static final QName _ReturnUsersAge_QNAME = new QName("http://example.com/scope", "age");
